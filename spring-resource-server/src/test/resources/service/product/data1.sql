...
insert into resource_server.product_catalog (id, name, price, currency, owner_id, inventory_id, category_id) values (1, 'abc', 100.00, 'USD', 1, 1, 1);
insert into resource_server.product_catalog (id, name, price, currency, owner_id, inventory_id, category_id) values (2, 'abc', 100.00, 'USD', 1, 2, 1);
insert into resource_server.product_catalog (id, name, price, currency, owner_id, inventory_id, category_id) values (3, 'abc', 100.00, 'USD', 1, 3, 1);
